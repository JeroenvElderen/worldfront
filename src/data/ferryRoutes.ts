...
export const curatedFerryRoutes: CuratedFerryRoute[] = [
  ...
  { id: 'stockholm-turku', name: 'Stockholm–Turku', originName: 'Värtahamnen Stockholm', destinationName: 'Port of Turku', durationMinutes: 660, coordinates: [[18.104, 59.35], [19.6, 59.8], [21.8, 60.2], [22.214, 60.435]] },
  ...
  { id: 'osaka-beppu', name: 'Osaka–Beppu', originName: 'Osaka Nanko Ferry Terminal', destinationName: 'Beppu International Port', durationMinutes: 720, coordinates: [[135.429, 34.619], [133.7, 34.0], [131.5, 33.4], [131.506, 33.303]] },
  ...
  { id: 'tangier-tarifa', name: 'Tangier–Tarifa', originName: 'Tangier Ville Port', destinationName: 'Port of Tarifa', durationMinutes: 60, coordinates: [[-5.81, 35.79], [-5.72, 35.9], [-5.605, 36.01]] },
  ...
  { id: 'buenos-aires-colonia', name: 'Buenos Aires–Colonia', originName: 'Puerto Madero Ferry Terminal', destinationName: 'Puerto de Colonia', durationMinutes: 75, coordinates: [[-58.368, -34.598], [-58.0, -34.55], [-57.843, -34.471]] },
  { id: 'buenos-aires-montevideo', name: 'Buenos Aires–Montevideo', originName: 'Puerto Madero Ferry Terminal', destinationName: 'Port of Montevideo', durationMinutes: 150, coordinates: [[-58.368, -34.598], [-57.4, -34.7], [-56.21, -34.9]] },
]
