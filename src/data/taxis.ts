...
export const taxiModels: TaxiModel[] = [
  ...
  { id: 'audi-rs6-avant', brand: 'Audi', name: 'RS 6 Avant', price: 132_000, capacity: 4, topSpeedKmh: 280, logoUrl: 'https://cdn.simpleicons.org/audi/eaf7f4', description: 'Super-estate for VIP transfers', powertrain: 'hybrid', marker: 'R', color: '#ef4444', collection: 'exclusive', tripSpeedMultiplier: 4 },
  { id: 'bmw-m5-touring', brand: 'BMW', name: 'M5 Touring', price: 145_000, capacity: 4, topSpeedKmh: 305, logoUrl: 'https://cdn.simpleicons.org/bmw/eaf7f4', description: 'Flagship performance touring car', powertrain: 'hybrid', marker: 'M', color: '#3b82f6', collection: 'exclusive', tripSpeedMultiplier: 4 },
  { id: 'mercedes-amg-gt63', brand: 'Mercedes-AMG', name: 'GT 63 S E Performance', price: 185_000, capacity: 4, topSpeedKmh: 316, logoUrl: 'https://cdn.simpleicons.org/mercedes/eaf7f4', description: 'Four-door hybrid grand tourer', powertrain: 'hybrid', marker: 'G', color: '#cbd5e1', collection: 'exclusive', tripSpeedMultiplier: 4 },
  { id: 'porsche-taycan-turbo', brand: 'Porsche', name: 'Taycan Turbo', price: 170_000, capacity: 4, topSpeedKmh: 260, logoUrl: 'https://cdn.simpleicons.org/porsche/eaf7f4', description: 'Electric VIP express saloon', powertrain: 'electric', marker: 'P', color: '#facc15', collection: 'exclusive', tripSpeedMultiplier: 4 },
]
