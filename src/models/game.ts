...
export interface TerritoryExpansion { id: string; coordinates: Coordinates; routeCoordinates?: Coordinates[]; purchasedAt: string; source?: 'purchase' | 'taxi-discovery'; radiusKm?: number }
