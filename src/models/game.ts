...
export interface Vehicle { id: string; name: string; type: 'taxi' | 'coach' | 'van'; value: number; condition: number; fuel: number; capacity: number; status: VehicleStatus; cityId: string; position?: Coordinates; driverId?: string }
